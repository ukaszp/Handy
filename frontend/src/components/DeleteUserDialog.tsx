...
const DeleteUserDialog = ({ isOpen, onOpenChange }) => {
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Ta akcja jest nieodwracalna. Użytkownik <span className="text-slate-900 font-bold text-">{selectedUser?.name} {selectedUser?.lastName}</span>  zostanie na stałe usunięty z bazy danych.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
